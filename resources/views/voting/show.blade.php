...
<div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
    <h2 class="text-xl font-bold text-gray-900 mb-2">💡 Suggest a Feature</h2>
    ...
    <a href="https://github.com/{{ $project->github_owner }}/{{ $project->github_repo }}/issues/new" 
       target="_blank"
       class="inline-flex items-center bg-gray-900 text-white px-6 py-3 rounded-md hover:bg-gray-800 font-medium transition-colors">
